...
import vn.demo.service.MovieChartService;
import vn.demo.service.MovieService;

/**
 * CONTROLLER (web) — Thymeleaf cho Movie (Bài 7).
 *
 * <p>Toàn bộ dùng {@code @Controller}: trả tên template hoặc {@code redirect:}.</p>
 */
@Controller
...
public class MovieViewController {
	...
	/** Biểu đồ top country — dữ liệu aggregation động. */
	@GetMapping("/chart")
	public String showChart(Model model) {
		// --- Aggregation MongoDB → labels/counts cho Chart.js ---
